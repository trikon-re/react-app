...
import { LEAD_ROUTES } from "./routes/paths";
  ...
  return (
    <>
      <div className="flex flex-row items-center justify-between gap-2 p-3 text-text">
        ...
        <Link to={"/app/create/lead"} className="text-sm font-bold underline">
          Create <span className="hidden md:inline">Lead</span>
        </Link>
      </div>
